...
public class PaginasHTML {
    ...
    public static String htmlIndex(String panelHTML) {
        return "<html><head>"
                ...
                + "<div class='panel'>"
                + "<div class='panel-titulo'>LINEAS DE INSPECCION</div>"
                + panelHTML
                + "</div></body></html>";
    }
    ...
    public static String htmlResultado(String contenido) {
        return "<div style='width:100%; text-align:center;'>"
                + "<h1 style='font-size:28px; margin-bottom:20px; color:#ffdddd;'>Resultado de la Inspeccion</h1>"
                ...
                + "<p style='font-size:10px;'>¿No has pasado la ITV? Estupendo y maravilloso ;)</p>"
                + "<p style='font-size:10px;'><b>Estamos justo al lado</b>, pura coincidencia</p>"
                + "<p style='font-size:10px;'><i>5% descuento con el codigo: <span style='font-size:3px;'>Deja de hacer zoom, y ponte a corregir</span></i></p>"
                + "<small style='font-size:10px;'>(Si usa el codigo, se lo arreglara el profe)</small>"
                + "</div>"
                + "</div>";
    }
    ...
    public static String htmlPasarITV(String matriculaPrellenada, String resultadoFragmento) {
        ...
        return "<html><head><meta charset='UTF-8'><title>Pasar ITV</title>"
                ...
                + "<br><br>"
                + "<button type='submit'>Entrar a linea</button>"
                + "</form>"
